        ...
        <div className="grid grid-cols-1 md:grid-cols-8 gap-3 gap-y-6">
          ...
          <div className="col-span-1 md:col-span-4 lg:col-span-3">
            <div className="flex flex-col text-white text-base space-y-5 md:space-y-0 md:flex-row">
              <div className="flex-1 text-center md:text-left">
                ...
                <ul className="text-neutral-grayish-violet">
                  <li className="hover:text-primary-cyan">Links Shortening</li>
                  <li className="hover:text-primary-cyan">Branded links</li>
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <ul className="text-neutral-grayish-violet">
                  ...
                  <li className="hover:text-primary-cyan">Careers</li>
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex justify-center space-x-4 mr-3 md:justify-end md:space-x-6">
              <svg className="w-6 h-6 fill-white hover:fill-primary-cyan" xmlns="http://www.w3.org/2000/svg">
