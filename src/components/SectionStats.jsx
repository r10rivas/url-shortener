    ...
    <div className="py-8 bg-slate-200">
      <div className="container mx-auto">
        <div className="mx-8 md:mx-2">
          <h2 className="text-center mb-8 font-semibold text-3xl text-neutral-very-dark-violet">
            Advanced Statistics
          </h2>
          <p className="text-center text-neutral-grayish-violet text-lg">
            Track how your links are performing across the web with our advanced statistics dashboard.
          </p>
          <div className="grid grid-cols-3 gap-x-4 gap-y-16 lg:gap-6 mt-14 relative after:content-[''] before:w-3 before:h-4/6 before:bg-primary-cyan before:bottom-1/2 md:before:bottom-2/3 before:left-1/2 before:transform before:translate-y-1/2 before:-translate-x-1/2 before:absolute md:before:w-5/6 md:before:h-3">
            <div className="col-span-3 md:col-span-1">
              <Card icon={IconBrandRecognition}>
                <>
                  <h3 className="mb-4 text-xl text-neutral-very-dark-violet font-bold">
                    Brand Recognition
                  </h3>
